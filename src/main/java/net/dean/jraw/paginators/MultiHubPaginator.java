...
//
///**
// * This is specially designed to iterate <a href="https://www.saidit.net/s/multihub">/s/multihub</a> and pick out
...
//        return String.format("/s/multihub/%s", sorting.name().toLowerCase());
//    }
//
//    @Override
